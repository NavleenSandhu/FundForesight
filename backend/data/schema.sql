...
CREATE TABLE notifications (
    ...
    user_id INT REFERENCES users(user_id) ON DELETE CASCADE,
    notification_type VARCHAR(50) NOT NULL CHECK(notification_type IN ('NEW_TRANSACTIONS', 'OVER_BUDGET_ALERT', 'LARGE_TRANSACTION_ALERT','SALARY_RECEIVED','LOW_BUDGET_WARNING', 'EXPENDITURE_REVIEW')),                                         
